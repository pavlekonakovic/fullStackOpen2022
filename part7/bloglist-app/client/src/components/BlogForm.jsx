  ...
  return (
    <div>
      ...
      <Box component='form' onSubmit={addBlog} noValidate sx={{ mb: 4 }}>
        <TextField required fullWidth variant='standard' {...newTitle} />
        <TextField required fullWidth variant='standard' {...newAuthor} />
        <TextField required fullWidth variant='standard' {...newUrl} />
